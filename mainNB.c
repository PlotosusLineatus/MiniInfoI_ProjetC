...
int main(int argc, char *argv[]){
    ...
    printf("Bienvenue sur l'application de Noémie, où nous traitons les trois premiers modules\n");
    printf("Avez-vous votre fichier contenant la séquence au format fasta \033[31;01msimplifié\033[00m?\n");
    printf("Veuillez taper Y une fois que votre fichier est prêt :) \n");
    scanf("%c",&Reponse);
    while(Reponse!='Y'){
        printf("Pas encore prêt? Ce n'est pas grave, nous vous attendons! ;) \n Tapez \033[33;01mY\033[00m quand vous êtes prêt!\n");
        scanf("%c",&Reponse);
    }
